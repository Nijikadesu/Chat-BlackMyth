...
class TinyGraph:
    ...
    def __init__(
        ...
        # 创建文件（如果不存在）
        _create_file_if_not_exists(self.doc_path)
        _create_file_if_not_exists(self.chunk_path)
        _create_file_if_not_exists(self.community_path)
    ...
    def split_text(self, file_path, segment_length=300, overlap_length=50) -> Dict:
        """
